...
if __name__ == "__main__":
    ...
    low_anx_df_path = Path("code/Task1/individual_tfmn/low_anxiety_personas.csv").resolve().absolute()
    low_anx_df = pd.read_csv(low_anx_df_path)
